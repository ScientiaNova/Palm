...
object InvertToken : IUnaryOperatorToken {
    override val unaryOp = Inv
    override fun toString() = "InvToken"
}

object NotToken : IUnaryOperatorToken {
    override val unaryOp = Not
