...
private fun matchIdentToken(ident: String, code: String, nextPos: StringPos) = when (ident) {
    ...
    "file" -> Token.File to nextPos
    "field" -> Token.Field to nextPos
    "delegate" -> Token.Delegate to nextPos
    "property" -> Token.Property to nextPos
    "param" -> Token.Param to nextPos
    "setparam" -> Token.Setparam to nextPos
