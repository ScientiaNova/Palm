...
fun parseTypeParam(parser: Parser) = TypeParam(parseIdent(parser))

fun parseTypeParams(parser: Parser, constraints: MutableList<Pair<PString, PType>>): List<TypeParam> =
