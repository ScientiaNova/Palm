...
const val enumTest = """
    ...
    enum Expr {
        Ident { name: String },
        Call { expr: PExpr, args: CallArgs },
        Lambda { label: PString?, params: LambdaParams, scope: ExprScope },
        If { cond: List[Condition], ifTrue: ExprScope, ifFalse: ExprScope? },
        When { comparing: PExpr?, branches: List[WhenBranch] },
        For {
            label: PString?,
            dec: PDecPattern,
            iterable: PExpr,
        ...
        Loop { label: PString?, body: ExprScope },
        Continue { label: PString? },
        Break { label: PString?, expr: PExpr? },
        Return { label: PString?, expr: PExpr? },
        Throw { expr: PExpr },
        Do { scope: ExprScope, catches: List[Catch] },
        Scope { scope: ExprScope },
        Byte { value: palm.Byte },
        Short { value: palm.Short },
        Int { value: palm.Int },
        Long { value: palm.Long },
        Float { value: palm.Float },
        Double { value: palm.Double },
        Char { value: palm.Char },
        Str { parts: List[StringPart] },
        Bool { value: Boolean },
        Null,
        This,
        Super,
        Tuple { elements: List[PExpr] },
        Lis { elements: List[PExpr] },
        Map { elements: List[Pair[PExpr, PExpr]] },
        Get { expr: PExpr, args: List[PExpr] },
        TypeCheck { expr: PExpr, type: PType },
        SafeCast { expr: PExpr, type: PType },
        NullableCast { expr: PExpr, type: PType },
        UnsafeCast { expr: PExpr, type: PType },
        MemberAccess { expr: PExpr, value: PString },
        SafeMemberAccess { expr: PExpr, value: PString },
        Turbofish { expr: PExpr, args: List[PTypeArg] },
        FunRef { on: PExpr?, value: PString },
        Spread { expr: PExpr },
        Unary { op: UnaryOp, expr: PExpr },
        Binary { first: PExpr, op: BinaryOp, second: PExpr },
        And { first: PExpr, second: PExpr },
        Or { first: PExpr, second: PExpr },
        Elvis { first: PExpr, second: PExpr },
        Eq { first: PExpr, second: PExpr },
        NotEq { first: PExpr, second: PExpr },
        RefEq { first: PExpr, second: PExpr },
        NotRefEq { first: PExpr, second: PExpr },
        Annotated { annotation: Annotation, expr: PExpr },
        Object { superTypes: List[SuperType], statements: List[ObjectStatement] }
    }
"""
